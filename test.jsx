...
const SiteCard = ({ site }) => {
  ...
  return (
    <div className="group relative overflow-hidden border border-gray-200 rounded-xl bg-white transition-all duration-300 hover:shadow-lg hover:-translate-y-1">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="text-gray-500 hover:text-[#FD7149] transition-colors duration-200 text-sm flex items-center"
              >
            ...
            <div className="flex space-x-2">
              <button className="p-2 text-gray-600 hover:text-[#FD7149] transition-colors duration-200 hover:bg-gray-50 rounded-full">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
              </button>
              <button 
                className="p-2 text-gray-600 hover:text-[#FD7149] transition-colors duration-200 hover:bg-gray-50 rounded-full"
                onClick={() => setIsExpanded(!isExpanded)}
              >
